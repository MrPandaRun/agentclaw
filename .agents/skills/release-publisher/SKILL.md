...
This is the Codex project-skill entrypoint for repository releases.
...
Prefer the shared playbook over duplicating release logic here so Codex and Claude Code stay aligned.
